...
/**
 * REST controller for managing {@link io.github.jhipster.sample.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Address> result = addressRepository
            ...
            .map(existingAddress -> {
                ...
                if (address.getMiddleName() != null) {
                    existingAddress.setMiddleName(address.getMiddleName());
                }
                ...
                if (address.getPhoneNumber1() != null) {
                    existingAddress.setPhoneNumber1(address.getPhoneNumber1());
                }
                if (address.getPhoneNumber1Type() != null) {
                    existingAddress.setPhoneNumber1Type(address.getPhoneNumber1Type());
                }
                if (address.getPhoneNumber2() != null) {
                    existingAddress.setPhoneNumber2(address.getPhoneNumber2());
                }
                if (address.getPhoneNumber2Type() != null) {
                    existingAddress.setPhoneNumber2Type(address.getPhoneNumber2Type());
                }
                if (address.getOrganisation() != null) {
                    existingAddress.setOrganisation(address.getOrganisation());
                }
                if (address.getDepartment() != null) {
                    existingAddress.setDepartment(address.getDepartment());
                }
