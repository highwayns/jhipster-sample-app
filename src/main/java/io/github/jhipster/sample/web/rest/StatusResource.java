...
import io.github.jhipster.sample.service.StatusService;
...
/**
 * REST controller for managing {@link io.github.jhipster.sample.domain.Status}.
 */
@RestController
@RequestMapping("/api")
public class StatusResource {
     ...
     */
    @GetMapping("/statuses")
    public ResponseEntity<List<StatusDTO>> getAllStatuses(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
