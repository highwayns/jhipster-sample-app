...
import io.github.jhipster.sample.service.TransactionsService;
...
/**
 * REST controller for managing {@link io.github.jhipster.sample.domain.Transactions}.
 */
@RestController
@RequestMapping("/api")
public class TransactionsResource {
    ...
    public ResponseEntity<List<TransactionsDTO>> getAllTransactions(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
