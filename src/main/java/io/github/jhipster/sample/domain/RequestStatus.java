...
public class RequestStatus implements Serializable {
    ...
    public RequestStatus id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public RequestStatus nameEs(String nameEs) {
    ...
    public RequestStatus nameRu(String nameRu) {
    ...
    public RequestStatus nameZh(String nameZh) {
