...
public class OrderTypes implements Serializable {
    ...
    public OrderTypes nameEn(String nameEn) {
    ...
    public OrderTypes nameEs(String nameEs) {
    ...
    public OrderTypes nameRu(String nameRu) {
    ...
    public OrderTypes nameZh(String nameZh) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrderTypes)) {
            return false;
        }
        return id != null && id.equals(((OrderTypes) o).id);
    }
