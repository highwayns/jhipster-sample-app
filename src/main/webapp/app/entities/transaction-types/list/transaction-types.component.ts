...
export class TransactionTypesComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.transactionTypesService
      ...
      .subscribe({
        next: (res: HttpResponse<ITransactionTypes[]>) => {
  ...
  trackId(_index: number, item: ITransactionTypes): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ITransactionTypes[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
