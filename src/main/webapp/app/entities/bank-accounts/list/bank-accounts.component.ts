...
export class BankAccountsComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.bankAccountsService
      ...
      .subscribe({
        next: (res: HttpResponse<IBankAccounts[]>) => {
  ...
  trackId(_index: number, item: IBankAccounts): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IBankAccounts[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
