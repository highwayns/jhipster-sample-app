...
describe('RequestTypes Management Component', () => {
  let comp: RequestTypesComponent;
  let fixture: ComponentFixture<RequestTypesComponent>;
  let service: RequestTypesService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'request-types', component: RequestTypesComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(RequestTypesComponent, '')
      .compileComponents();
