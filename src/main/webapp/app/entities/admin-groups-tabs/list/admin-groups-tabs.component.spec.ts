...
describe('AdminGroupsTabs Management Component', () => {
  let comp: AdminGroupsTabsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'admin-groups-tabs', component: AdminGroupsTabsComponent }]),
      ...
      .overrideTemplate(AdminGroupsTabsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.adminGroupsTabs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
