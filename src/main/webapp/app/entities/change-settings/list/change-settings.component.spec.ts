...
describe('ChangeSettings Management Component', () => {
  let comp: ChangeSettingsComponent;
  let fixture: ComponentFixture<ChangeSettingsComponent>;
  let service: ChangeSettingsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'change-settings', component: ChangeSettingsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ChangeSettingsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.changeSettings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
