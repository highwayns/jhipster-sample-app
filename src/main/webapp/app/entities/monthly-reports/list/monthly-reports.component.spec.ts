...
describe('MonthlyReports Management Component', () => {
  let comp: MonthlyReportsComponent;
  let fixture: ComponentFixture<MonthlyReportsComponent>;
  let service: MonthlyReportsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'monthly-reports', component: MonthlyReportsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(MonthlyReportsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.monthlyReports?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
