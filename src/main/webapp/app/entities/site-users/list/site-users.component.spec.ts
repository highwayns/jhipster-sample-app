...
describe('SiteUsers Management Component', () => {
  let comp: SiteUsersComponent;
  let fixture: ComponentFixture<SiteUsersComponent>;
  let service: SiteUsersService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'site-users', component: SiteUsersComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SiteUsersComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.siteUsers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
