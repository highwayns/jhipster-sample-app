...
describe('AppConfiguration Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'app-configuration', component: AppConfigurationComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.appConfigurations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
