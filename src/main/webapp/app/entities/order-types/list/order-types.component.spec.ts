...
describe('OrderTypes Management Component', () => {
  let comp: OrderTypesComponent;
  let fixture: ComponentFixture<OrderTypesComponent>;
  let service: OrderTypesService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'order-types', component: OrderTypesComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(OrderTypesComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.orderTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
