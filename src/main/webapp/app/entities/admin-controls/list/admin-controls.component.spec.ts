...
describe('AdminControls Management Component', () => {
  let comp: AdminControlsComponent;
  let fixture: ComponentFixture<AdminControlsComponent>;
  let service: AdminControlsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'admin-controls', component: AdminControlsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(AdminControlsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.adminControls?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
