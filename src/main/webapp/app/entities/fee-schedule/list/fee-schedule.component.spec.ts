...
describe('FeeSchedule Management Component', () => {
  let comp: FeeScheduleComponent;
  let fixture: ComponentFixture<FeeScheduleComponent>;
  let service: FeeScheduleService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'fee-schedule', component: FeeScheduleComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(FeeScheduleComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.feeSchedules?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
