...
export class FeeScheduleComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.feeScheduleService
      ...
      .subscribe({
        next: (res: HttpResponse<IFeeSchedule[]>) => {
  ...
  trackId(_index: number, item: IFeeSchedule): number {
    return item.id!;
  }

  delete(feeSchedule: IFeeSchedule): void {
    const modalRef = this.modalService.open(FeeScheduleDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.feeSchedule = feeSchedule;
  ...
  protected onSuccess(data: IFeeSchedule[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
