...
export class CurrenciesService {
  ...
  update(currencies: ICurrencies): Observable<EntityResponseType> {
    return this.http.put<ICurrencies>(`${this.resourceUrl}/${getCurrenciesIdentifier(currencies) as number}`, currencies, {
      observe: 'response',
    });
  }

  partialUpdate(currencies: ICurrencies): Observable<EntityResponseType> {
    return this.http.patch<ICurrencies>(`${this.resourceUrl}/${getCurrenciesIdentifier(currencies) as number}`, currencies, {
      observe: 'response',
    });
  }
