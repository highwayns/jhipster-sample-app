...
describe('ContentFiles Management Component', () => {
  let comp: ContentFilesComponent;
  let fixture: ComponentFixture<ContentFilesComponent>;
  let service: ContentFilesService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'content-files', component: ContentFilesComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ContentFilesComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.contentFiles?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
