...
describe('CurrentStats Management Component', () => {
  let comp: CurrentStatsComponent;
  let fixture: ComponentFixture<CurrentStatsComponent>;
  let service: CurrentStatsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'current-stats', component: CurrentStatsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CurrentStatsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.currentStats?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
