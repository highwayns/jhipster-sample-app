...
describe('AdminSessions Management Component', () => {
  let comp: AdminSessionsComponent;
  let fixture: ComponentFixture<AdminSessionsComponent>;
  let service: AdminSessionsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'admin-sessions', component: AdminSessionsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(AdminSessionsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.adminSessions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
