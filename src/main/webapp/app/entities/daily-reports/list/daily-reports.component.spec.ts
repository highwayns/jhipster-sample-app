...
describe('DailyReports Management Component', () => {
  let comp: DailyReportsComponent;
  let fixture: ComponentFixture<DailyReportsComponent>;
  let service: DailyReportsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'daily-reports', component: DailyReportsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DailyReportsComponent, '')
      .compileComponents();
