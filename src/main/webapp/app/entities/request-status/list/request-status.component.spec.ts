...
describe('RequestStatus Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'request-status', component: RequestStatusComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.requestStatuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
