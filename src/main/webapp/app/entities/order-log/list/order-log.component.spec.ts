...
describe('OrderLog Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'order-log', component: OrderLogComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.orderLogs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
