...
describe('AdminOrder Management Component', () => {
  let comp: AdminOrderComponent;
  let fixture: ComponentFixture<AdminOrderComponent>;
  let service: AdminOrderService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'admin-order', component: AdminOrderComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(AdminOrderComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.adminOrders?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
