...
export class ContentUpdateComponent implements OnInit {
  ...
  protected updateForm(content: IContent): void {
    this.editForm.patchValue({
      ...
      contentEnContentType: content.contentEnContentType,
      contentEs: content.contentEs,
      contentEsContentType: content.contentEsContentType,
      titleRu: content.titleRu,
      titleZh: content.titleZh,
      contentRu: content.contentRu,
      contentRuContentType: content.contentRuContentType,
      contentZh: content.contentZh,
      contentZhContentType: content.contentZhContentType,
    });
  }
