...
describe('HistoryActions Management Component', () => {
  let comp: HistoryActionsComponent;
  let fixture: ComponentFixture<HistoryActionsComponent>;
  let service: HistoryActionsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'history-actions', component: HistoryActionsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(HistoryActionsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.historyActions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
