...
describe('Conversions Management Component', () => {
  let comp: ConversionsComponent;
  let fixture: ComponentFixture<ConversionsComponent>;
  let service: ConversionsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'conversions', component: ConversionsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ConversionsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.conversions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
