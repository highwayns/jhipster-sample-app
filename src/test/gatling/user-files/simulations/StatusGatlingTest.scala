...
class StatusGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Status entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "lastSweep":"2020-01-01T00:00:00.000Z"
                , "deficitBtc":"0"
                , "hotWalletBtc":"0"
                , "warmWalletBtc":"0"
                , "totalBtc":"0"
                ...
                , "dbVersion":"0"
                , "cronDailyStats":"2020-01-01T00:00:00.000Z"
                , "cronGetStats":"2020-01-01T00:00:00.000Z"
                , "cronMaintenance":"2020-01-01T00:00:00.000Z"
                , "cronMonthlyStats":"2020-01-01T00:00:00.000Z"
                , "cronReceiveBitcoin":"2020-01-01T00:00:00.000Z"
                , "cronSendBitcoin":"2020-01-01T00:00:00.000Z"
                }""")).asJson
            .check(status.is(201))
