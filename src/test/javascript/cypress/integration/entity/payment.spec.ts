...
describe('Payment e2e test', () => {
  ...
  describe('new Payment page', () => {
    ...
    it('should create an instance of Payment', () => {
      cy.get(`[data-cy="reference"]`).type('22078').should('have.value', '22078');

      cy.get(`[data-cy="createDateTimeUtc"]`).type('2022-07-08T04:50').should('have.value', '2022-07-08T04:50');

      cy.get(`[data-cy="status"]`).select('PENDING');

      cy.get(`[data-cy="amountToCollect"]`).type('62596').should('have.value', '62596');

      cy.get(`[data-cy="surchargeAmount"]`).type('24811').should('have.value', '24811');

      cy.get(`[data-cy="convertedTotalAmount"]`).type('56218').should('have.value', '56218');

      cy.get(`[data-cy="convertedCurrency"]`).select('USD');

      cy.get(`[data-cy="conversionRate"]`).type('63013').should('have.value', '63013');

      cy.get(`[data-cy="paidAmount"]`).type('58719').should('have.value', '58719');
