...
class IssuerResourceIT {
    ...
    public static Issuer createEntity(EntityManager em) {
        Issuer issuer = new Issuer().name(DEFAULT_NAME);
        return issuer;
    }
    ...
    public static Issuer createUpdatedEntity(EntityManager em) {
        Issuer issuer = new Issuer().name(UPDATED_NAME);
        return issuer;
    }
    ...
    void getAllIssuers() throws Exception {
        ...
        issuer.setId(UUID.randomUUID().toString());
        ...
        restIssuerMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(issuer.getId())))
    ...
    void getIssuer() throws Exception {
        ...
        restIssuerMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(issuer.getId()))
    ...
    void putNewIssuer() throws Exception {
        ...
        updatedIssuer.name(UPDATED_NAME);
