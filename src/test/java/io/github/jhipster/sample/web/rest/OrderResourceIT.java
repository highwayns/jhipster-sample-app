...
import io.github.jhipster.sample.domain.Order;
import io.github.jhipster.sample.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    private static final Long DEFAULT_CUSTOMER_REFERENCE = 1L;
    private static final Long UPDATED_CUSTOMER_REFERENCE = 2L;
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getCreateDateTimeUtc()).isEqualTo(DEFAULT_CREATE_DATE_TIME_UTC);
        assertThat(testOrder.getCustomerReference()).isEqualTo(DEFAULT_CUSTOMER_REFERENCE);
    }
    ...
    void getAllOrders() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].customerReference").value(hasItem(DEFAULT_CUSTOMER_REFERENCE.intValue())));
    }
    ...
    void getOrder() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.customerReference").value(DEFAULT_CUSTOMER_REFERENCE.intValue()));
    }
    ...
    void putNewOrder() throws Exception {
        ...
        assertThat(testOrder.getCreateDateTimeUtc()).isEqualTo(UPDATED_CREATE_DATE_TIME_UTC);
        assertThat(testOrder.getCustomerReference()).isEqualTo(UPDATED_CUSTOMER_REFERENCE);
    }
